...
import { cobImages } from "@/lib/imageExports";
    ...
    <div className="mb-20 mt-12 flex flex-col items-center justify-center">
      <div className="flex max-w-screen-lg flex-col items-center justify-center space-y-5 px-8">
        ...
        <p className="px-12 text-center">
          These can be enabled or disabled to change the difficulty of the game
          in different ways. Each one of them makes the game harder in a unique
          manner.
          <br />
        ...
        <p className="px-12 text-center">
          ...
          <br />
          The Lamp mini-boss featured here is one of the most lethal enemies in
          the game. It slays you in a single hit if you ignore the flashing
          warning signs.
        </p>
        <Separator className="w-4/5" />
        ...
        <p className="px-12 text-center">
          ...
          from mini-bosses. You can activate these with right click and you can
          only hold one at a time.
        </p>
        <Separator className="w-4/5" />
        <Image src={cobImages.ss3} alt="Gameplay screenshot" />
        <p className="px-12 text-center">
          Normal enemies drop random food passives that fire extra projectiles.
          These damage enemies and eventually turn you into a juggernaut.
          <br />
          Bosses drop 3 special boss only passives at a time and you are allowed
          to choose one of these before progressing. Boss passives are vastly
          more powerful and carry much more intricate effects.
          <br />
        ...
        <p className="px-12 text-center">
          There is a secret level hidden in the world. Many players have already
          found it but nobody quite knows how just yet.
        </p>
        <Separator className="w-4/5" />
        ...
        <p className="px-12 text-center">
          The Teapot is a shorter range, hardy, and small champion that tends to
          have a tough time fighting the Television. This image can be used as a
          1080p background.
        </p>
